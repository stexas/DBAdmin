Ext.namespace("Ext.DBADMIN.grid.filter");
Ext.DBADMIN.grid.filter.Filter = function(config){
	...
	this.events = {
		 ...
		 * @param {Ext.DBADMIN.grid.filter.Filter} this
		 */
		'activate': true,
		/**
		 * @event deactivate
		 ...
		 * @param {Ext.DBADMIN.grid.filter.Filter} filter The filter being serialized.
		 **/
		'serialize': true
	};
	Ext.DBADMIN.grid.filter.Filter.superclass.constructor.call(this);
...
Ext.extend(Ext.DBADMIN.grid.filter.Filter, Ext.util.Observable, {
	/**
	 * @cfg {Boolean} active
