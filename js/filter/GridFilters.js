/**
 * Ext.DBADMIN.grid.GridFilters v0.2.7
 **/

Ext.namespace("Ext.DBADMIN.grid");
Ext.DBADMIN.grid.GridFilters = function(config){		
...
Ext.extend(Ext.DBADMIN.grid.GridFilters, Ext.util.Observable, {
	/**
	 ...
	 * 
	 * @param {Object/Ext.DBADMIN.grid.filter.Filter} config A filter configuration or a filter object.
	 * 
	 * @return {Ext.DBADMIN.grid.filter.Filter} The existing or newly created filter object.
	 */
	 ...
	 * 
	 * @return {Ext.DBADMIN.grid.filter.Filter}
	 */
	...
	getFilterClass: function(type){
		return Ext.DBADMIN.grid.filter[type.substr(0, 1).toUpperCase() + type.substr(1) + 'Filter'];
	}
});