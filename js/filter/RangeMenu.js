Ext.namespace("Ext.DBADMIN.menu");
Ext.DBADMIN.menu.RangeMenu = function(){
	Ext.DBADMIN.menu.RangeMenu.superclass.constructor.apply(this, arguments);
	this.updateTask = new Ext.util.DelayedTask(this.fireUpdate, this);

	var cfg = this.fieldCfg;
	var cls = this.fieldCls;
	var fields = this.fields = Ext.applyIf(this.fields || {}, {
		'gt': new Ext.DBADMIN.menu.EditableItem({
			iconCls:  this.icons.gt,
			editor: new cls(typeof cfg == "object" ? cfg.gt || '' : cfg)}),
		'lt': new Ext.DBADMIN.menu.EditableItem({
			iconCls:  this.icons.lt,
			editor: new cls(typeof cfg == "object" ? cfg.lt || '' : cfg)}),
		'eq': new Ext.DBADMIN.menu.EditableItem({
...
Ext.extend(Ext.DBADMIN.menu.RangeMenu, Ext.menu.Menu, {
